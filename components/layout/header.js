...
// import NotificationPopover from "../common/notification_popover";
                ...
                defaultLang === undefined ?
                    ...
                    <div className="flex justify-between items-center h-full p-4">
                        ...
                        <div className="flex items-center gap-x-6">
                            ...
                            <Popover placement="bottomRight" trigger="click" arrow={mergedArrow} title={null} className="">
                                <button>
                                    <FiBell size={18} />
                                </button>
                            </Popover>
                            <div>
                                <Select
                                    defaultValue={i18n.languages?.find(lang => lang?.default)?.name}
