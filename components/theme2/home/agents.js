...
function Agents() {
    ...
    return (
        <section className='relative bg-gray_text py-32'>
            ...
            <div className='container mx-auto'>
                <div className='my-10 text-center'>
                    <h1 className='header_2 after:last: text-dark_text'>Meet Our Amazing Agents</h1>
                </div>
                <div className='grid min-h-[450px] grid-cols-1 items-center gap-5 md:grid-cols-2 lg:grid-cols-4'>
                ...
                {
                    path === '/agents' ? <div className='flex text-center justify-center'>
