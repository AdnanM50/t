...
const Testimonial = () => {
    ...
    return (
        <section className='relative bg-light_text py-16'>
            ...
            <div className='container mx-auto py-20 testimonial-slider'>
                <div className='mx-auto mb-8 w-full md:w-1/2'>
                    <h1 className='header_2 py-4 text-center '>What our clients says about us</h1>
                </div>
        ...
        <div className='relative z-10 xl:!max-w-[486px] rounded-b-lg rounded-tr-lg bg-white p-8 pl-14 mx-auto ml-10 md:ml-12 mb-8 md:mb-12'>
            ...
            <div className=''>
                <div className='flex pb-2'>
                    <Rate className='text-primary' disabled defaultValue={testimonial?.rating} />
                </div>
