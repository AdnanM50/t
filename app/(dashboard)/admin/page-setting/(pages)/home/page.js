    ...
    useEffect(() => {
        ...
        if (page) {
            form.setFieldsValue({
                ...
                hero_section_image: (JSON.parse(page?.content)?.hero_section?.hero_section_image?.length > 0
                    ? [
                        {
                            uid: '-1',
                            name: 'image.png',
                ...
                explore_places: {
                    ...
                    explore_place_one: {
                        ...
                        image: (JSON.parse(page?.content)?.explore_places?.explore_place_one?.image?.length > 0
                            ? [
                                {
                                    uid: '-1',
                                    name: 'image.png',
                    ...
                    explore_place_two: {
                        ...
                        image: (JSON.parse(page?.content)?.explore_places?.explore_place_two?.image?.length > 0
                            ? [
                                {
                                    uid: '-1',
                                    name: 'image.png',
                    ...
                    explore_place_three: {
                        ...
                        image: (JSON.parse(page?.content)?.explore_places?.explore_place_three?.image?.length > 0
                            ? [
                                {
                                    uid: '-1',
                                    name: 'image.png',
            ...
            <Card>
                <Form
                    ...
                    onFinish={async (values) => {
                        ...
                        if (values?.hero_section_image?.length > 0) {
                        ...
                        if (values?.explore_places?.explore_place_one?.image?.length > 0) {
                        ...
                        if (values?.explore_places?.explore_place_two?.image?.length > 0) {
                        ...
                        if (values?.explore_places?.explore_place_three?.image?.length > 0) {
                    ...
                    <div className="border p-3 rounded">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="col-span-1">
                                <MultipleImageInput name={"hero_section_image"} label={("Image")} />
                            </div>
                        </div>
                    </div>
