    ...
    useEffect(() => {
        ...
        if (page) {
            form.setFieldsValue({
                ...
                sweet_journey_image: (JSON.parse(page?.content)?.sweet_journey?.sweet_journey_image?.length > 0
                    ? [
                        {
                            uid: '-1',
                            name: 'image.png',
                    ...
                    : []),
                // download_app: {
                //     heading: JSON.parse(page?.content)?.download_app?.heading,
                //     description: JSON.parse(page?.content)?.download_app?.description,
                //     user: {
                //         google_play: JSON.parse(page?.content)?.download_app?.user?.google_play,
                //         app_store: JSON.parse(page?.content)?.download_app?.user?.app_store,
                //     },
                //     driver: {
                //         google_play: JSON.parse(page?.content)?.download_app?.driver?.google_play,
                //         app_store: JSON.parse(page?.content)?.download_app?.driver?.app_store,
                //     },
                //     owner: {
                //         google_play: JSON.parse(page?.content)?.download_app?.owner?.google_play,
                //         app_store: JSON.parse(page?.content)?.download_app?.owner?.app_store,
                //     },
                // },
            });
        }
            ...
            <Card>
                <Form
                    ...
                    onFinish={async (values) => {
                        ...
                        if (values?.sweet_journey_image?.length > 0) {
